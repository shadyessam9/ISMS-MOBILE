...
class Data{
  ...
  final name;
  final depart;
  Data({this.type,this.model,thisports,this.ip,this.picd,this.st,this.company,this.name,this.depart,this.ports});
...
class ITswitchinfo extends StatefulWidget {
  String asscid;
  ITswitchinfo ({this.asscid});



  @override
  _ITswitchinfo createState() => _ITswitchinfo ();
}

class _ITswitchinfo  extends State<ITswitchinfo> {
