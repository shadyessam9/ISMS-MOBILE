...
class Data{
  ...
  final name;
  final depart;
  Data({this.type,this.model,thisports,this.dvr,this.picd,this.st,this.company,this.name,this.depart});
...
class ITcamerainfo extends StatefulWidget {
  String asscid;
  ITcamerainfo ({this.asscid});



  @override
  _ITcamerainfo createState() => _ITcamerainfo ();
}

class _ITcamerainfo  extends State<ITcamerainfo> {
