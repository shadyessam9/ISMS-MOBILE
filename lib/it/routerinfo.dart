...
class ITrouterinfo extends StatefulWidget {
  String asscid;
  ITrouterinfo ({this.asscid});



  @override
  _ITrouterinfo createState() => _ITrouterinfo ();
}

class _ITrouterinfo  extends State<ITrouterinfo> {
