...
class Reserv extends StatefulWidget {
  Reserv({Key key, this.title}) : super(key: key);
...
class _Reserv extends State<Reserv> with SingleTickerProviderStateMixin {
  @override
                    ...
                    child:Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                "YOUR DEVICE IS BEING CURRENTLY "
                                    " MAINTAINED PLEASE BE PATENTED "
                                    "AND WAIT TILL REACTIVATION",
                                textAlign: TextAlign.center,
                                style: GoogleFonts.lato(
                                  color: isDarkMode ? const Color(0xff3DA2E4) : const Color(0xff3DA2E4),
