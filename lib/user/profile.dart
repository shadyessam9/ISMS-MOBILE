...
class Data{
  ...
  final depart;
  final position;
  Data({this.type,this.processor,this.ram,this.hardtype,this.capacity,this.imaged,this.state,this.company,this.imagec,this.name,this.depart,this.position});
...
class Uprofile extends StatefulWidget {
  String asscid;
  Uprofile ({this.asscid});



  @override
  _Uprofile createState() => _Uprofile ();
}

class _Uprofile  extends State<Uprofile> {
                            ...
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: isDarkMode
                                      ? Colors.transparent
                                      : Colors.transparent, //icon bg color
