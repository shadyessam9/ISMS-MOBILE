...
class Bprinterinfo extends StatefulWidget {
  String asscid;
  Bprinterinfo ({this.asscid});



  @override
  _Bprinterinfo createState() => _Bprinterinfo ();
}

class _Bprinterinfo  extends State<Bprinterinfo> {
