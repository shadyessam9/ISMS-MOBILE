...
import 'package:smart_maintainace/barren/camerainfo.dart';
import 'package:smart_maintainace/barren/dvrinfo.dart';
import 'package:smart_maintainace/barren/printerinfo.dart';
import 'package:smart_maintainace/barren/routerinfo.dart';
import 'package:smart_maintainace/barren/switchinfo.dart';
import '../main.dart';
...
class Bscanner extends StatefulWidget {
  final String asscid;
  Bscanner({Key key,@required this.asscid}) : super(key: key);
...
class _Bscanner extends State<Bscanner> {
  ...
  Future scan() async {
    ...
    var response = await http.post("https://"+MyApp().ip.trim()+"/adit/getstate.php", body:{"id":bar});
    var type = jsonDecode(response.body);
    if(type=="PC"||type=="LAPTOP"||type=="SERVER" ){
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => Bdeviceinfo(asscid:bar)),
      );
    }else if(type=="ROUTER"){
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => Brouterinfo(asscid:bar)),
      );
    }else if(type=="SWITCH"){
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => Bswitchinfo(asscid:bar)),
      );
    }else if(type=="CAMERA"){
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => Bcamerainfo(asscid:bar)),
      );
    }else if(type=="DVR"){
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => Bdvrinfo(asscid:bar)),
      );
    }else if(type=="PRINTER"){
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => Bprinterinfo(asscid:bar)),
      );
    }
  }
